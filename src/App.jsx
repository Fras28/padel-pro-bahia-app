...
import { faHome, faTrophy, faUsers, faVolleyballBall } from '@fortawesome/free-solid-svg-icons'; // Importa los iconos sólidos específicos
...
// Componente para la barra de navegación inferior (MobileNavBar)
const MobileNavBar = () => {
    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-3 z-50 flex justify-around items-center border-t border-gray-200">
            ...
            <button
                ...
                className="flex flex-col items-center text-gray-700 hover:text-blue-900 transition duration-300 text-xs"
            >
               {/* CAMBIO A fill="currentColor" AQUÍ */}
<svg fill="currentColor" width="25px" height="25px" viewBox="0 0 24 24" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
function App() {
  ...
  // selectedTournament state removed as TournamentMatches will fetch its own data
        ...
        <div className="relative py-3 w-full sm:max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
          ...
          <div className="relative bg-white shadow-lg sm:rounded-3xl p-4 sm:p-8">
            ...
            <div className="flex justify-center">
             <NavLink to="/"> <img src={PadelPro} alt="" width='108px'/></NavLink>
            </div>
            ...
            <Routes>
              ...
              <Route path="/clubs/:clubId/categories" element={
                <>
                  {selectedClub ? (
                    <Categories
                      club={selectedClub}
              ...
              <Route path="/clubs/:clubId/categories/:categoryId/ranking" element={
                <>
              ...
              <Route path="/tournaments/:tournamentId/matches" element={
                <TournamentMatches API_BASE={API_BASE} />
              } />
