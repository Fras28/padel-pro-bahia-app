...
import {
  ...
  faUsers,
  faVolleyballBall,
  faQuestionCircle, // Importa el nuevo icono para Ayuda
} from "@fortawesome/free-solid-svg-icons"; // Importa los iconos sólidos específicos
  ...
  return (
    ...
    <div className="fixed bottom-0 right-0 z-50 p-4 flex flex-col items-end">
      ...
      >
        ...
        <span className={baseTextClasses}>Ayuda</span>
      </button>
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white shadow-lg p-3 z-50 flex justify-around items-center border-t border-gray-200">
      ...
      <button
        ...
        className="flex flex-col items-center bg-slate-100 text-gray-700 hover:text-blue-900 transition duration-300 text-xs"
      >
        <FontAwesomeIcon icon={faQuestionCircle} className="text-lg mb-1" />
        Ayuda
      </button>
    </div>
  );
...
function App() {
  ...
  const [isAltNavBarActive, setIsAltNavBarActive] = useState(false); // New state for toggling nav bar
        ...
        <div className="relative py-3 w-full sm:max-w-xl md:max-w-2xl lg:max-w-4xl mx-auto">
          ...
          <div className="relative bg-white shadow-lg sm:rounded-3xl p-4 sm:p-8">
            ...
            <div className="flex justify-center">
              <NavLink to="/" onDoubleClick={handleLogoDoubleClick}> {/* Double-click handler */}
                <img src={PadelPro} alt="PadelPro Logo" width="108px" />
              </NavLink>
            </div>
         ...
         <Route path="/clubs/:clubId/categories" element={<Categories />} />
              ...
              />
              <Route path="/help" element={<Help />} /> {/* Nueva ruta para el componente Help */}
              <Route
                path="*"
                element={
