...
function TournamentMatches({ tournament, onBack }) {
  // Changed props to receive the full tournament object
  if (!tournament) {
    return (
      <div className="p-6 bg-white rounded-xl shadow-lg relative w-full max-w-2xl mx-auto my-8">
        ...
        <p className="text-center text-gray-600">
          No se ha seleccionado ningún torneo para mostrar detalles.
        </p>
      </div>
    );
  }
  ...
  const clubLogoUrl =
    ...
    "https://placehold.co/40x40/cccccc/333333?text=Club";
